...
Element1_K_linear = truss.ElementStiffMatrix(E,A,[nodes[0],nodes[1]])
...
Element_List_K_linear = [[Element1_K_linear,E,A,[nodes[0],nodes[1]]]]
Element_List_M = [[Element1_M,E,A,[nodes[0],nodes[1]]]]

K_master = truss.AssembleElementMatrices(Element_List_K)
K_master_linear = truss.AssembleElementMatrices(Element_List_K_linear)
...
K_mod_linear, F_mod_linear = truss.ModifyMasterMatrix(K_master_linear,F_master,Bc_List)
